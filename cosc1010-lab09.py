...
# Lab 09
# Lab Section:15
# Sources, people worked with, help given to: google and copitiot 
# Your
# Comments
# Here
...
class Pizzeria:
    ...
    def get_receipt(self):
        pizza = self.pizzas[-1]
        size_price, topping_price, total_price = self.get_price(pizza)
...
print(f'Total number of orders: {pizzeria.get_number_of_orders()}')
